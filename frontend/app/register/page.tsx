...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, Brain, Sparkles } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-700">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-teal-400 to-purple-500 bg-clip-text text-transparent mb-2">Create Account</h1>
